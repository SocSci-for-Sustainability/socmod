...
In the first example we initialize and run, then visualize adaptation prevalence 
over time, with a single model initalized with a single set of model parameters.  In the second example we set up a computational experiment to analyze how 
simulated prevalence dynamics and intervention success rate depend on the adaptive fitness when agents learn via success-biased social learning.
