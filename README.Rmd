...
Someone who has developed agent-based models of social behavior may be able to guess at some things going on behind the scene in the following code block that creates, runs, and visualizes the dynamics of an agent-based model of adaptive behavior diffusion. 
