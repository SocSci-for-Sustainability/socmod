...
The four-household population has the following structure: . We can initialize the agents and their social network as follows, encapsulated in a helper function `make_small_abm()`:
...
ggsave("vignettes/resources/adaptive_fitness_experiment.png", p, 
       width = 5, height = 3)
```
![Example computational experiment testing effect of adaptive fitness on success rate across the three learning strategies.](resources/adaptive_fitness_experiment.png)
...
![Example computational experiment testing effect of adoption rate on success rate across the three learning strategies.](resources/adoption_rate_experiment.png)